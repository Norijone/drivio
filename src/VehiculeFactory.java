/**
 * Fabrique responsable de la création et de la validation des véhicules
 * à partir de données brutes (String). Centralise la validation pour que
 * le chargement CSV et le formulaire de la GUI appliquent exactement les
 * mêmes règles et lèvent les mêmes exceptions (évite la duplication).
 *
 * Ajouter un nouveau type de véhicule ne demande qu'un nouveau "case" ici
 * et une nouvelle sous-classe de Vehicule (OCP) : aucun code appelant
 * (LecteurCSV, GUI) n'a besoin d'être modifié.
 */
